...
async fn test_deposited_initial_governance_tokens() {
    ...
    let governance_token_holding_account = root_governance_cookie.governance_token_holding_account;

    // Act
    let voter_record_cookie = governance_test
        .with_initial_governance_token_deposit(&root_governance_cookie, Some(10))
        .await;
...
async fn test_deposited_initial_council_tokens() {
    ...
    let council_token_holding_account = root_governance_cookie
        .council_token_holding_account
        .unwrap();

    // Act
    let voter_record_cookie = governance_test
        .with_initial_council_token_deposit(&root_governance_cookie)
        .await;
